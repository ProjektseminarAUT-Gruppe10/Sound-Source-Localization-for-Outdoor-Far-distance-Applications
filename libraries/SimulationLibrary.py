...
def simulate(config, source_position, signal_function):
    sim = simulation.Simulation(config["amplitude"],
                                ...
                                source_position=source_position,#config["source_position"],
    ...
    result = simulation_loader.SimulationLoader(signals, config["sample_rate"])
    return result