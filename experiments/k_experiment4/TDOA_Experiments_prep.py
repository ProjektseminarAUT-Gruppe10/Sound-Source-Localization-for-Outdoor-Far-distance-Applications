...
#            
#            TDOA_CSOM1, t, csom = tdoa_csom(signalAF, signalBF, fs=meta["sampling_rate"], window=1000)
#            TDOA_CSOM2, t, csom = tdoa_csom(signalCF, signalDF, fs=meta["sampling_rate"], window=1000)
#            TDOA_real1 = getRealTDOA(source_pos, micA, micB)
#            TDOA_real2 = getRealTDOA(source_pos, micC, micD)
#
#            TDOA_realls1.append(TDOA_real1)
#            TDOA_realls2.append(TDOA_real2)
#            TDOA_csomls1.append(TDOA_CSOM1)
#            TDOA_csomls2.append(TDOA_CSOM2)
#            TDOAstdErr1.append((TDOA_real1-TDOA_CSOM1)*(TDOA_real1-TDOA_CSOM1))
#            TDOAstdErr2.append((TDOA_real2-TDOA_CSOM2)*(TDOA_real2-TDOA_CSOM2))
#            
#        print(dis, ";", ang, ";", source_pos, ";", np.average(TDOAstdErr1), ";", np.std(TDOAstdErr1), ";", np.average(TDOAstdErr2), ";", np.std(TDOAstdErr2))
#        print(dis, ";", ang, ";", source_pos, ";", np.average(SNRls) , ";", np.std(SNRls), ";", np.average(TDOA_realls) , ";", np.std(TDOA_realls), ";", np.average(TDOA_csomls) , ";", np.std(TDOA_csomls), file=f)
#
#f.close()
...
X,Y = KarstenDOA_calculateCurve_linear(micA, micB, TDOA_CSOM1*343.2, res=0.1, rang=20)
plt.plot(X,Y)
X,Y = KarstenDOA_calculateCurve_linear(micC, micD, TDOA_CSOM2*343.2, res=0.1, rang=20)
plt.plot(X,Y)
plt.grid(True)
plt.show()
